...
### 2. Hermes-Oráculo (subsistema A) — design aprovado, falta implementar
- Spec completo: `docs/ecossistema/A-hermes-oraculo-spec.md`
- Próximo passo: escrever plano de implementação (skill writing-plans) → implementar.
- Credenciais pendentes do Sol: token BotFather, chat_id, confirmar SSH a Polaris, modelo Ollama de chat.

### 3. Frota — 3 estrelas com função a confirmar
Sol precisa confirmar o papel de: **Rigel** (labsobral-214), **Bellatrix** (labsrv05-218), **Vega** (labtools01-150). Não ler inventário sensível — perguntar ao Sol.
