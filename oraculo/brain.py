...
SYSTEM_PROMPT = (
    ...
    "Em follow-ups (histórico presente): o RAG só vale se o resultado é claramente sobre o repo "
    "da conversa — se for sobre outro repo/assunto, descarte e diga "
    "'não tenho essa informação sobre [repo] no contexto atual'. "
